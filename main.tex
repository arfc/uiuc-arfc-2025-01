...
\section{Geospatial Information}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{Sites Storing Spent Nuclear Fuel and Reprocessing Waste at the End of 2022. \cite{carter_spent_2023}}
        \label{fig1}
    \end{figure}
...
\subsection{Commercial \gls{SNF} Inventory} 
 ...
 storage facility after plant decommissioning.\\
    ...
    \begin{figure}[H]
        ...
        \end{center}
            \caption{Commercial \gls{NPP} and (non-\gls{DOE}) \glspl{ISFSI} currently store spent nuclear fuel across the United States \cite{carter_spent_2023}.}
        \label{fig2}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{center}
            \caption{This figure presents the burnup (GWd/MTHM) and initial enrichment (\% $^{235}U$) distributions for spent nuclear fuel assemblies through December 2022 \cite{carter_spent_2023}.}
        \label{fig4}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{The average annual burnup (GWd/MT) and initial enrichment (\% $^{235}$U) of U.S. spent nuclear fuel \cite{carter_spent_2023}.}
        \label{fig5}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{Decay heat of \gls{PWR} fuel discharged at 60 GWd/MT \cite{carter_spent_2023}.}
        \label{fig6}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{Decay heat of \gls{BWR} fuel that was discharged at 50 GWd/MT \cite{carter_spent_2023}.}
        \label{fig7}
    \end{figure}
