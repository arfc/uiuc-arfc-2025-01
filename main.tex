...
\section{U.S. Commercial Spent Nuclear Fuel Inventory} 
 ...
 storage facility after plant decommissioning.\\
    ...
    Figure~\ref{fig2} depicts the geographic distribution of commercial reactor and ISFSI sites currently storing SNF. 
    ...
    As seen in Table~\ref{tab4} and Figures~\ref{fig6} the decay heat profile for PWR fuel discharged at 60~GWd/MT. At early cooling times, decay heat is 
    ...
    Table~\ref{tab5} and Figures~\ref{fig7} present corresponding decay heat characteristics for BWR fuel discharged at 50~GWd/MT. Similar to the PWR case, 
...
\section{SNF at DOE Locations}
    ...
    and must be packaged in specialized canisters prior to disposal. Table~\ref{tab7} provides a breakdown of the decay heat characteristics for all 950 canisters containing SNF of NPR origin.
...
trying bib..~\cite{gohar_ads_2021}
