...
\section{}
\subsection{U.S. Commercial Spent Nuclear Fuel Inventory} 
...
begining, etc.  } 
    ...
    risen from about 2\% $^{235}U$\todo{The writing checklist is clear, this should 
    be $^{235}U$, not $^{235}U$. Please check whole document for these instances 
...
\section{\gls{SNF} at \gls{DOE} Locations}
    ...
    By the end of 2022, \gls{DOE} managed approximately 2,446~MTHM of \gls{SNF} (excluding naval fuel), as documented in the Spent Fuel Database
     \todo{cite the database here -- also, is SFD its real name?}. To 
