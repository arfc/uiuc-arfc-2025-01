\section{Introduction}
    ...
    produced in 2025 and incorporates the updated data and isotopic information from the STANDARDS~5.0.1 database \cite{??},
...
\subsection{Commercial \gls{SNF} Inventory} 
 ...
 storage facility after plant decommissioning.\\
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{This figure presents the average annual burnup (GWd/MT) and initial enrichment (\% $^{235}$U) of U.S. spent nuclear fuel \cite{carter_spent_2023}.}
        \label{fig5}
    \end{figure}
...
\draw[->] (xds.east) -- ++(5,0)
    node[midway, above, annot]{LLFP};

\draw[->] (xds.east) ++(0,-0.5) -- ++(5,0)
    node[midway, above, annot]{Other FP};
