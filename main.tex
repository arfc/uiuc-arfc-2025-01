...
\section{Geospatial Information}
    ...
    \begin{figure}[H]
        \begin{center}
            \includegraphics[width=1.5\textwidth]{figures/US_map.png}
        \end{center}
...
begining, etc.  } 
    ...
    \begin{figure}[H]
        ...
        \end{center}
            \caption[Burn-up (GWd/MTHM) \& Initial Enrichment (\% $^{235}U$) by Number 
    ...
    \begin{figure}[H]
        ...
        \end{center}
        \caption{Average Annual Burn up (GWd/MT) and Enrichment ($^{235}U$\%)}
        \label{fig5}
    \end{figure}
