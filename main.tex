...
\subsection{Commercial \gls{SNF} Inventory} 
 ...
 storage facility after plant decommissioning.\\
    ...
    In this work, STANDARDS 5.0.1 provides the modern, expanded equivalent of the UDB used by \textit{Bae et al.}
...
\subsection{\gls{SNF} at \gls{DOE} Locations}
    ...
    challenges in characterization, consolidation, and long term disposal planning.\\
     ...
     By the end of 2022, \gls{DOE} managed approximately 2,446~MTHM of \gls{SNF} (excluding naval fuel), as documented in the GC-859 database.
...
\section{Incorporating the National \gls{SNF} Inventory into \textsc{Cyclus}}
    ...
    different scenarios\cite{herrera-martinez_transmutation_2007}.\\
...
\end{figure}
    ...
    When LLFP transmutation is not activated in the scenario, long lived isotopes such as $^{99}Tc$, $^{129}I$, $^{126}Sn$, and $^{107}Pd$ remain in the output inventory.
