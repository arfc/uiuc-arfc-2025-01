...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \vspace{0.2cm}
     \begin{minipage}{0.4\textwidth}
        ...
        {\begin{flushright}\huge\bfseries Summary of Nuclear Waste Inventory in the U.S.
                           \end{flushright}}
        {\begin{flushright}\large\textit{EINSTEIN Milestone 1.1}
        \end{flushright}}
        \end{minipage}
    ...
    {\large \date{December 15, 2025}}% January 1, 3000
...
Isolation of Nuclides ,' Award Number 
    DE-AR0002080, part of the ARPA-E NEWTON program (DE-FOA-0003418).}
